...
def run_ensemble_prediction(msa_path, output_path, jobname, max_seq, extra_seq, env, seeds=10, save_all=False):
    ...
    print(f'Read {complete_output_path}_{max_seq}_{extra_seq}/log.txt to monitor output')
